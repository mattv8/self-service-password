...
$messages['policy'] = "Your password must meet all of the following:";
$messages['policyminlength'] = "Must be at least {$pwd_min_length} characters long.";
$messages['policymaxlength'] = "Cannot be longer than {$pwd_max_length} characters.";
$messages['policyminlower'] = "Must contain at least {$pwd_min_lower} lowercase characters.";
$messages['policyminupper'] = "Must contain at least {$pwd_min_upper} uppercase characters.";
$messages['policymindigit'] = "Must contain {$pwd_min_digit} digit(s).";
$messages['policyminspecial'] = "Must contain {$pwd_min_special} special character(s).";
...
$messages['sendtokenhelp'] = "Enter your username and your email address to reset your password. When you receive the email, click the link inside to complete the password reset.";
$messages['sendtokenhelpnomail'] = "Enter the username part of your email address to reset your password (do not include the \"@iechs.org\" part). An email will then be sent to your \"@iechs.org\" email address associated with the supplied username. When you receive this email, click the link inside to complete the password reset.";
$messages['mail'] = "Mail";
$messages['mailrequired'] = "Your email address is required";
$messages['mailnomatch'] = "The email address does not match the submitted username";
...
$messages['smsresetmessage'] = "Your password reset token for your Itineris account is:";
...
$messages['menutoken'] = "Reset by email";
$messages['menusms'] = "Reset by text message";
...
$messages['emptychangeform'] = "If already you know your password, you may change it here. Otherwise use the \"Reset by email\" or \"Reset by text message\" options above.";
$messages['emptysshkeychangeform'] = "Change your SSH Key";
$messages['emptysendtokenform'] = "Email a password reset link to your @iechs.org email address";
$messages['emptyresetbyquestionsform'] = "Reset your password";
$messages['emptysetquestionsform'] = "Set your password reset questions";
$messages['emptysendsmsform'] = "Get a reset code sent to the phone number registered to your Itineris account";
