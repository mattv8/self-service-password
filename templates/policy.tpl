...
<div class="help alert alert-warning">
    ...
    <ul>
        {if $pwd_min_length } <li>{$msg_policyminlength|unescape: "html" nofilter}</li> {/if}
        {if $pwd_max_length } <li>{$msg_policymaxlength|unescape: "html" nofilter}</li> {/if}
        {if $pwd_min_lower } <li>{$msg_policyminlower|unescape: "html" nofilter}</li> {/if}
        {if $pwd_min_upper } <li>{$msg_policyminupper|unescape: "html" nofilter}</li> {/if}
        {if $pwd_min_digit } <li>{$msg_policymindigit|unescape: "html" nofilter}</li> {/if}
        {if $pwd_min_special } <li>{$msg_policyminspecial|unescape: "html" nofilter}</li> {/if}
